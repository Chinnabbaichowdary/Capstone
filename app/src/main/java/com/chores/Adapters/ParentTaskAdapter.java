...
import com.chores.ViewCompleteTaskActivity;
...
public class ParentTaskAdapter  extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Button btnview=(Button) obj2.findViewById(R.id.btnview);
        btnview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context, ViewCompleteTaskActivity.class);
                intent.putExtra("pic",task.get(position).getImage());
