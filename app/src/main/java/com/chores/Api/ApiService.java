...
public interface ApiService {
    ...
    @GET("/Chores/getChildNotification.php?")
    Call<List<Notification>> getChildNotification(
            @Query("email") String email);
    ...
    @Multipart
    @POST("Chores/updateTaskStautsnew.php")
    Call<ResponseData> updateTaskStautsnew(
